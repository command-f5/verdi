		...
		switch(variable_get('importkit_content_module_use', 'ubercart'))
		{
			case 'commerce':
				...
				$form[__CLASS__]['Settings']['importkit_order_state'] = array(
					...
					'#default_value' => $this->getVariable('importkit_order_state', 'completed'),
				);
			...
			case 'ubercart':
				...
				'#description' => t(''),
				'#type' => 'radios',
				'#default_value' => $this->getVariable('importkit_order_user_info', 1),
				'#options' => array(
				...
				if(function_exists('uc_order_status_list'))
				{
					...
					$form[__CLASS__]['Settings']['importkit_order_state'] = array(
						...
						'#options' => $options,
						'#default_value' => $this->getVariable('importkit_order_state', 'pending'),
						'#weight' => 10,
			...
			break;
				...
				$form[__CLASS__]['Price info']['importkit_order_curency'] = array(
						'#type' => 'textfield',
						'#title' => t(''),
						'#description' => t('The currency 1C code'),
						'#default_value' => $this->getVariable('importkit_order_curency', 'руб.'),
				);
