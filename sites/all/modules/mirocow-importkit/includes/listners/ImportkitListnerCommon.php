...
class ImportkitListnerCommon extends ImportkitListner implements InterfaceObserver
{
	...
	public function settings_form($form_state = array(), $submit = false)
	{
		...
		$form[__CLASS__]['importkit_data_path'] = array(
			...
			'#weight' => 10,
			'#default_value' =>  $this->getVariable('importkit_data_path', ''),
		);
		...
		$form[__CLASS__]['importkit_content_module_use'] = array(
			...
			'#title' => t('Module use'),
			'#options' => $options,
			'#default_value' => $this->getVariable('importkit_content_module_use', 'ubercart'),
			'#weight' => 20,
		...
		$form[__CLASS__]['importkit_common_product_format'] = array(
			...
			'#title' => t('Text format'),
			'#options' => $options,
			'#default_value' => $this->getVariable('importkit_common_product_format', 'plain'),
			'#weight' => 30,
		...
		$form[__CLASS__]['importkit_image_settings'] = array(
			...
			'#weight' => 40,
			'#default_value' => $this->getVariable('importkit_image_settings', 1),
